...
| アクター | ログイン済みユーザー |
| 事前条件 | 招待コードを持っている |
| 基本フロー | 1. ホーム画面で「参加する」をタップ<br>2. 6桁のイベントコードを入力<br>3. 次へボタンを押す<br>4. イベント情報を確認<br>5. 参加するボタンを押す |
...
| アクター | イベント主催者/参加者 |
| 事前条件 | イベントに参加している |
| 基本フロー | 1. イベント詳細画面を開く<br>2. 参加者タブを選択 |
| 事後条件 | 参加者一覧が表示される |
...
| アクター | イベント主催者 |
| 事前条件 | 自分が主催するイベントが存在する |
| 基本フロー | 1. 参加者タブを開く<br>2. 追加ボタンをタップ<br>3. 参加者名を入力<br>4. （オプション）スキルレベル/性別を設定<br>5. 追加ボタンを押す |
| 事後条件 | 手動参加者が追加される |
...
| アクター | イベント主催者 |
| 事前条件 | 参加者が存在する |
| 基本フロー | 1. 参加者タブを開く<br>2. 参加者をタップ<br>3. 出席状況を選択（出席予定/不参加/未定） |
| 事後条件 | 出席状況が更新される |
...
| アクター | イベント主催者 |
| 事前条件 | イベント当日 |
| 基本フロー | 1. 参加者タブを開く<br>2. 参加者のチェックインボタンをタップ<br>3. または一括チェックインを実行 |
...
| アクター | イベント主催者 |
| 事前条件 | 参加者が存在する |
| 基本フロー | 1. 参加者タブを開く<br>2. 参加者をスワイプまたは長押し<br>3. 削除を選択<br>4. 確認ダイアログで削除を確定 |
| 事後条件 | 参加者が削除される |
...
| 基本フロー | 1. 参加者タブを開く<br>2. 参加者をタップ<br>3. スキルレベル/性別を選択<br>4. 保存 |
| 事後条件 | 参加者情報が更新される |
...
| アクター | イベント参加者 |
| 事前条件 | 参加費が未払い |
| 基本フロー | 1. 集金タブを開く<br>2. 支払い報告ボタンをタップ |
